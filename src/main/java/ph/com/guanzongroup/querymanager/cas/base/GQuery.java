...
public class GQuery {
    ...
    private static LogWrapper logwrapr = new LogWrapper("querymgrfx.GQuery",
            System.getProperty("sys.default.path.config") + "/temp/GQuery.log");
...
//        gchain = poGRider.getGDBFChain(branchip);
        ...
        //initialize GDBFChain make Connection
        gchain = new GDBFChain();
        gchain.doDBFChain(branchcd, poGRider.getUserID(), poGRider.getGConnection().getConnection());

        String ip = "";
        ip = validBranch(branchcd, gchain.getConnection());
...
//            }
    ...
    private String getRights(String userid) {
        ...
        try {
            ...
            if (loRS.next()) {
//                System.out.print("Encrypted Engineer = " + poGRider.Encrypt("engineer", "sysadmin"));
//                System.out.print("Encrypted Encoder = " + poGRider.Encrypt("encoder", "sysadmin"));
//                System.out.print("Encrypted Supervisor = " + poGRider.Encrypt("supervisor", "sysadmin"));
//                System.out.print("Encrypted SysAdmin = " + poGRider.Encrypt("sysadmin", "sysadmin"));
...
//    private List<String> listAllSchemas(Connection conn) {
